...
from lightning.cli.lightning_cli import ssh


@mock.patch("lightning_cloud.login.Auth.authenticate", MagicMock())
@mock.patch("inquirer.prompt")
@mock.patch("lightning.cli.cmd_apps._AppManager.list_apps")
@mock.patch("lightning.cli.cmd_apps._AppManager.list_components")
@mock.patch("lightning.cli.cmd_apps._AppManager.get_app")
@mock.patch("lightning.cli.cmd_apps._AppManager.get_cluster")
@mock.patch("os.execv")
